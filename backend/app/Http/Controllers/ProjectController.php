    ...
    public function store(Request $request)
    {
        ...
        $project = Project::create([
            ...
            'members'       => $validated['members'] ?? [
                ['name' => Auth::user()?->name ?? 'Principal Investigator', 'role' => 'Principal Investigator', 'avatar' => Auth::user()?->avatar ?? 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=150'],
            ],
            'last_activity' => now(),
        ]);
    ...
    protected function serializeProject(Project $project): array
    {
        ...
        return [
            ...
            'members'      => $project->members ?? [
                ['name' => 'Dr. Evelyn Evans', 'role' => 'Principal Investigator', 'avatar' => 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=150'],
            ],
